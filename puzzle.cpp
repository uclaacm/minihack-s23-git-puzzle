...
int sumDigits(int Bananas) {
  ...
  int main() {
    ...
    Node* head1 = new Node();
    head1->val = 1; head1 -> next = nullptr;
    Node* head2 = new Node(); 
    head2-> val = 2; head2 -> next = nullptr; 
    Node* node1 = new Node(); 
    node1 -> val = 3; node1 -> next = nullptr; 
    Node* node2 = new Node(); 
    node2 -> val = 4; node2 -> next = nullptr; 
    Node* node3 = new Node(); 
    node3 -> val = 5; node3 -> next = nullptr; 
    head1->next = node1;
    node1->next = node3;
    head2->next = node2;
